# Paisawasolbro - fix mojibake + re-apply white/red theme
# Run from inside your project folder: C:\Users\DELL\Desktop\paisawasolbro
Write-Host "Rewriting files with correct UTF-8 encoding..." -ForegroundColor Cyan
...
'@
[System.IO.File]::WriteAllText('tailwind.config.ts', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('app/globals.css', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('app/layout.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/Marquee.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/Hero.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/CategoryGrid.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/ProductCard.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/ExclusivePicks.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/TodaysPicks.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))

Write-Host "  - components/Nav.tsx"
New-Item -ItemType Directory -Force -Path 'components' | Out-Null
$content = @'
...
'@
[System.IO.File]::WriteAllText('components/Nav.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))
...
'@
[System.IO.File]::WriteAllText('components/Footer.tsx', $content, (New-Object System.Text.UTF8Encoding($false)))

Write-Host "All files rewritten cleanly." -ForegroundColor Green

git add .
git commit -m "Fix character encoding (rupee sign, dashes, arrows)"
git push

Write-Host "Done. Vercel will redeploy automatically in a minute or two." -ForegroundColor Cyan
