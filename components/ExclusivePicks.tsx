  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col gap-6 border border-inkLine bg-inkSoft px-6 py-[42px] md:flex-row md:items-center md:justify-between md:px-10 md:py-[73px]">
          <div>
